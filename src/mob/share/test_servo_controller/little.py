...
try:
    ...
    #stage 1
    sp.write('#16 P1500 #17 P1650 #18 P1500 #19 P1600 #20 P1550 #21 P1600 #22 P1500 #23 P1600 #24 P1600 #25 P1550 T1000 \r')
    sleep(2)

    print('Stage 2 - Lean Left')
    # stage 2
    sp.write('#16 P1300 #17 P1600 #18 P1500 #19 P2000 #20 P1600 #21 P1600 #22 P1500 #23 P1600 #24 P1600 #25 P1550 T1000 \r')
    sleep(2)

    #print('Stage 3 - Right Foot')
    # stage 3
    #sp.write('#21 P1500 #22 P800 #23 P1700 #24 P1500 #25 P1550 T2000 \r')
    #sleep(2)
