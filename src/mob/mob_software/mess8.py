...
class MobSoft:
    def __init__(self):
        ...
        # PID RIGHT LEG
        self.pid_left_x = PID(1, 0.005, 0.2, setpoint=100)
        self.pid_left_x.sample_time = 0.3
        self.pid_left_y = PID(0.97, 0.005, 0.2, setpoint=90)
        self.pid_left_y.sample_time = 0.3
        # PID RIGHT LEG
        self.pid_right_x = PID(1, 0.005, 0.2, setpoint=90)
        self.pid_right_x.sample_time = 0.3
        self.pid_right_y = PID(0.97, 0.005, 0.2, setpoint=90)
