...
class MobSoft:
    def __init__(self):
        ...
        # PID RIGHT LEG
        self.pid_right_x = PID(1, 0.002, 0.2, setpoint=90)
        self.pid_right_x.sample_time = 0.3
        self.pid_right_y = PID(0.97, 0.002, 0.2, setpoint=90)
        self.pid_right_y.sample_time = 0.3
        # Motors
        self.motor_x = 90
        self.motor_y = 90
        # MPU6050
    ...
    def run(self, sp):
        ...
        sp.write('#14 P1500 #15 P1500 #16 P1500 #17 P1600 #18 P1500 #19 P1700 #20 P1600 #21 P1600 #22 P1500 #23 P1600 #24 P1600 #25 P1750 #26 P1500 #27 P1700 #28 P1500 #29 P1600 #30 P1500 #31 P1500 T1000 \r')
        ...
        while True:
            try:
                ...
                # PID x control
                control_output_x = int(self.pid_right_x(diff_x)) # feed x error into the pid controller
                self.pid_right_x.setpoint = 90 
                
                # PID y control
                control_output_y = int(self.pid_right_y(diff_y)) # feed y error into the pid controller
