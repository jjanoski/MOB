...
class PID (object):
    ...
    def __init__(self, kp, kd, ki, min_output, max_output, integrator_min, integrator_max):
        ...
        self.m_minOutput = min_output         # largest output from controller
        self.m_maxOutput = max_output         # smallest output from controller
        self.m_integratorMin = integrator_min    # maximum integral value
        self.m_integratorMax = integrator_max    # minimum integral value
    ...
    def update(self, value, target_value):
        ...
        self.m_previousTime = update_time
