...
class MobSoft:
    ...
    def angle_command_multiple(self,ser,
        ...
        #print(str(set_value))
        if 499 < set_head < 2501 and 499 < set_cam < 2501 and 499 < set_l_shoulder < 2501 and 499 < set_l_elbow < 2501 and 499 < set_l_hand < 2501 and 499 < set_l_thigh < 2501 and 499 < set_l_knee < 2501 and 499 < set_l_thigh < 2501 and 499 < set_l_knee < 2501 and 499 < set_l_foot < 2501 and 499 < set_r_shoulder < 2501 and 499 < set_r_elbow < 2501 and 499 < set_r_hand < 2501 and 499 < set_r_thigh < 2501 and 499 < set_r_knee < 2501 and 499 < set_r_foot < 2501 :
            command = '#'+head+' P'+str(set_head)+' #'+cam+' P'+str(set_cam)+' #'+left_shoulder+' P'+str(set_l_shoulder)+' #'+left_elbow+' P'+str(set_l_elbow)+' #'+left_hand+' P'+str(set_l_hand)+' #'+left_thigh+' P'+str(set_l_thigh)+' #'+left_knee+' P'+str(set_l_knee)+' #'+left_foot+' P'+str(set_l_foot)+' #'+right_shoulder+' P'+str(set_r_shoulder)+' #'+right_elbow+' P'+str(set_r_elbow)+' #'+right_hand+' P'+str(set_r_hand)+' #'+right_thigh+' P'+str(set_r_thigh)+' #'+right_knee+' P'+str(set_r_knee)+' #'+right_foot+' P'+str(set_r_foot)+' T1000 \r'
            print(command)
    ...
    def stand(self, sp):
        ...
        right_knee_out     = 50
        right_foot_out     = 100
        self.angle_command_multiple(sp, head_out, cam_out, left_shoulder_out, left_elbow_out, left_hand_out, left_thigh_out, left_knee_out, left_foot_out, right_shoulder_out, right_elbow_out, right_hand_out, right_thigh_out, right_knee_out, right_foot_out,)
